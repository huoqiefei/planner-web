                ...
                {tab === 'General' && (
                    <div className="max-w-4xl grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div className="space-y-2">
                            <div>
                                <label className="block text-slate-500 mb-0.5 font-semibold">{t('ResourceID')}</label>
                                <input disabled value={resource.id} className="w-full border border-slate-300 px-1 py-1 bg-slate-50 text-slate-500" />
                            </div>
                            <div>
                                <label className="block text-slate-500 mb-0.5 font-semibold">{t('ResourceName')}</label>
                                <input value={resource.name} onChange={e => updateRes('name', e.target.value)} className="w-full border border-slate-300 px-1 py-1" />
                            </div>
                        </div>
                        <div className="space-y-2">
                            <div>
                            ...
                            <div>
                                <label className="block text-slate-500 mb-0.5 font-semibold">{t('Unit')}</label>
