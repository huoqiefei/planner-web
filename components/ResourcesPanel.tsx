...
const ResourcesPanel: React.FC = () => {
    ...
    return (
        <div className="flex-grow flex flex-col h-full bg-white select-none" onKeyDown={handleKeyDown} tabIndex={0} onClick={()=>setCtx(null)}>
            {/* Toolbar */}
                        ...
                        <div className="flex-grow overflow-auto bg-slate-50">
                             ...
                             {resources.length === 0 && (
                                 <div className="p-8 text-center text-slate-400 flex flex-col items-center gap-2">
                                     ...
                                     <button onClick={addRes} className="text-blue-500 hover:underline">{t('CreateFirstResource')}</button>
                                 </div>
                             )}
                        </div>
                    </div>
